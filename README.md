...
[Stream Now!](https://youtu.be/6W8haS31SAI) Also Consider [Subscribing](https://www.youtube.com/c/epicprogrammer?sub_confirmation=1). The source code is in [demo/index.js](./demo/index.js).
...
You can also pass [orbit-controls](https://threejs.org/docs/#examples/en/controls/OrbitControls) options, for example `phi` as the initial rotation, or passing `{ rotate: fale }` to ignore mouse/touch rotation.
